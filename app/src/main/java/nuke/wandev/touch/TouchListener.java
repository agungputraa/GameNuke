...
/**
 * Game Nuke Touch Listener JNI Bridge for libwandev.so.
 * Must match the exact class name and method signatures expected by libwandev.so:
 *  - Java_nuke_wandev_touch_TouchListener_nativeStart
 *  - Java_nuke_wandev_touch_TouchListener_nativeStop
 *  - Java_nuke_wandev_touch_TouchListener_nativeIsRunning
 *  - Java_nuke_wandev_touch_TouchListener_nativeSetGrab
